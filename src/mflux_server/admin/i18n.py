...
STRINGS = {
    ...
    "cached_models": {"en": "Local models", "zh": "本地模型"},
    "cached_empty": {"en": "Nothing in the models directory yet.", "zh": "模型目录里还没有内容。"},
    "models_dir_hint": {"en": "Models live here (download or copy in manually):",
                         "zh": "模型放在这里（下载或手动复制进来）："},
    ...
    "lbl_models_dir": {"en": "Models dir", "zh": "模型目录"},
